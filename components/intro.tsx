    ...
    <section ref={ref} id="home" className="mb-28 max-w-[50rem] text-center sm:mb-0 scroll-mt-[100rem]">
        <div className="flex items-center justify-center">
            <div className="relative">
                ...
                >
                    <Image src={Profile} alt="Celso portrait"
                    quality="95"
                    priority={true}
        ...
        >
            <span className="font-bold">Hello, I'm Celso.</span> I'm an{" "}
            ...
            <span className="underline">React (Next.js)</span> and {" "}<span className="underline">Django REST Framework</span>.
        </motion.h1>
